...
const eventsData = [
  {
    ...
    "description": "A technical challenge to solve real-world problems in Ed-Tech, Smart Environment, AI & Web3, FinTech, and Social Innovation.",
    "startDate": "2025-11-01T09:00:00Z",
    "endDate": "2025-11-01T18:00:00Z",
    "timeline": "9:00 AM to 6:00 PM onwards",
    "prizes": "[\"₹6,000 + T-shirts/Stickers (1st)\", \"₹4,000 + Caps (2nd)\", \"₹3,000 (3rd)\", \"Internship opportunities at Vectorteklabs\"]",
    "faqs": "[]",
    "organizerContact": "Priyanshu Kayarkar (+91 9373690752)",
    "coOrganizerContact": "Muchkundraj Thote (+91 90968 30986)",
    "bannerImage": "PRARAMBH_Hackathon_Poster",
    "gallery": "[\"Hackathon_working_session_1\", \"Hackathon_working_session_2\"]",
    "details": "Organized in collaboration with ACM, CSE Department. Features tracks like AI & Web3 and Open Innovation.",
  ...
  },
  {
    ...
    "description": "A platform for young innovators to pitch creative and feasible startup ideas and overcome stage fear.",
    "startDate": "2025-11-01T11:00:00Z",
    "endDate": "2025-11-01T16:00:00Z",
    "timeline": "Starts at 11:00 AM",
    "prizes": "[\"Total Prize Pool: ₹10,000\", \"Goodies\", \"Internship Opportunities\"]",
    "faqs": "[]",
    "organizerContact": "Samyak Umathe (9146655108)",
    "coOrganizerContact": "Ishika Lanjewar (7498682969)",
    "bannerImage": "Ideathon_StartupWave_Poster",
    "gallery": "[\"Ideathon_Presentation_Session\"]",
    "details": "Conducted in collaboration with GFG, GHRCOEM. Judged by industry founders from HiTech Pathshala and Bizleap.",
  ...
  },
  {
    ...
    "description": "An intellectually stimulating campus-wide hunt involving 3 rounds of decoding complex clues and challenges.",
    ...
    "bannerImage": "Treasure_Hunt_Poster",
    "gallery": "[\"Treasure_Hunt_Activity_1\"]",
    "details": "Tests logical reasoning, teamwork, and presence of mind. More than 350 participants.",
  ...
  },
  {
    ...
    "description": "Keynote session on Agentic AI, Generative AI, and Intelligent Automation with practical demonstrations.",
    ...
    "bannerImage": "AI_Seminar_Poster",
    "gallery": "[\"Seminar_Auditorium_View\"]",
    "details": "Speaker: Mr. Neeraj Thosar (MSc CS, Univ. of Nottingham). Hands-on with Azure AI and Python frameworks.",
  ...
  },
  {
    ...
    "description": "Central India's biggest hackathon held at IIIT Nagpur to foster innovation and practical IT skills.",
    ...
    "details": "Part of Abhyudaya 25.0. 600+ Participants. Evaluated by alumni and HCL members.",
  ...
  {
    "name": "Donation Drive",
    "description": "Social initiative to support underprivileged children from orphanages and blind schools.",
    ...
    "bannerImage": "Donation_Drive_Poster",
    "gallery": "[\"Donation_Drive_Group_Photo\"]",
    "details": "Collecting stationary, toys, and clothes. Introduction to 'Be My App' for visually impaired children.",
...
async function seedEvents() {
  try {
    ...
    // Insert events with proper data types
