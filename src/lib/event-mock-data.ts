...
Learn about the latest design trends, tools, and methodologies that are shaping the future of digital and physical product experiences. Whether you're a seasoned professional or just starting your design journey, this conference offers valuable insights for every level.`,
  ...
  image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&q=80&w=2340',
  ...
  faqs: [
    {
      ...
      answer: "Your registration includes access to all keynote presentations, workshops, networking events, coffee breaks, and lunch on both days. You'll also receive a conference goodie bag with exclusive design merchandise."
    },
    {
      question: "Is there a student discount available?",
      answer: "Yes, students with valid ID can register at a 50% discount. Please email a copy of your student ID to studentregistration@designconference2023.com after completing registration."
    },
    {
      question: "What's the cancellation policy?",
      answer: "Cancellations made 30 days before the event will receive a full refund minus a $50 processing fee. Cancellations made within 30 days will receive a 50% refund. No refunds will be issued for cancellations within 7 days of the event."
    },
    {
      question: "Will the sessions be recorded?",
      answer: "Yes, all keynote presentations and selected workshops will be recorded. Attendees will receive access to the recordings approximately two weeks after the event."
    },
    {
      question: "Is there a dress code?",
      answer: "The dress code is smart casual. We recommend comfortable clothing and shoes as you'll be moving between sessions throughout the day."
    }
  ],
  prizes: [
    {
  ...
  tags: ['Design', 'UX/UI', 'Professional Development', 'Workshops', 'Networking']
};
  ...
  faqs: [
    {
      ...
      answer: "Yes, all presenters have agreed to share their slides. Attendees received access to a digital resource library two weeks after the summit."
    },
    {
      question: "Was there a startup pitch competition?",
      answer: "Yes, the summit featured a pitch competition with over $100,000 in prize money. Twenty startups were selected to present to a panel of venture capitalists."
    },
    {
      question: "What networking opportunities were available?",
      answer: "The summit included structured networking sessions, a networking app for attendees, evening receptions, and themed lunch tables for specific industries and interests."
    }
  ],
  schedule: [
    {
...
export const checkRegistrationStatus = async (eventId: string, email: string): Promise<boolean> => {
  // Simulate API call delay
