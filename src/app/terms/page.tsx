...
export const metadata = {
  title: "Terms of Service | Engineering India YCCE",
  description: "Terms of Service for Engineering India YCCE.",
};
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#0F1B40] px-4 py-24 text-white">
      <div className="mx-auto w-full max-w-2xl text-center">
        ...
        <p className="mx-auto mb-10 max-w-md text-base leading-relaxed text-white/60">
          We&apos;re working on our Terms of Service. This page will be
        ...
        <div className="mb-10 rounded-[2rem] border border-white/10 bg-white/5 p-8 text-left backdrop-blur-xl">
          ...
          <p className="text-sm leading-relaxed text-white/60">
            By using the Engineering India YCCE platform, you agree to use it
            for lawful purposes related to club activities, event registration,
            and community engagement. Misuse of the platform or impersonation of
            club members is strictly prohibited.
          </p>
        </div>
