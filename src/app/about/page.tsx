      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
        <div>
          ...
          <Typography className="mb-4">
            ...
            are a passionate group of students and tech enthusiasts dedicated to
            exploring and advancing technology together.
          </Typography>
          <Typography className="mb-4">
            Our mission is to create an inclusive environment where members can
            learn, collaborate, and grow their technical skills while building
            meaningful connections with fellow tech enthusiasts.
          </Typography>
          <Typography className="mb-4">
