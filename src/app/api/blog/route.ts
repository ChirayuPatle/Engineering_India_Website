...
export async function GET() {
  const blogContainer = [
    {
      img: "https://res.cloudinary.com/priyanshukayarkar/image/upload/v1751962683/Veer_vandana_il20kj.jpg",
    ...
    {
      img: "https://res.cloudinary.com/priyanshukayarkar/image/upload/v1751962697/RASHTRABHIMAN_rb3t4m.png",
