...
import { cn } from "@/libs/utils"; // Adjust this import per your project structure
import {
  Canvas,
  useFrame,
  useThree,
...
// Extend Three.js objects so they can be used in JSX
extend({
  Mesh: THREE.Mesh,
...
// If you prefer inline global declarations (not recommended if you already have a d.ts file),
// you could also include the following code here (commented out):
