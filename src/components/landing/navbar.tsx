...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className={`container mx-auto flex h-10 items-center justify-between rounded-3xl px-6 py-10 backdrop-blur-sm transition-all duration-300 ${scrolled ? "bg-white/30 shadow-md" : "bg-white/20"}`}>
